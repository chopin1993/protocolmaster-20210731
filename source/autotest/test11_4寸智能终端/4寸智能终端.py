...
# 配置测试报告基本信息
config = dict()
config["测试程序名称"] = r"ESDT-CTP4(v1.5)-202102223"
# 定义抄控器的基本信息
config["串口"] = "COM23"
...
# 定义测试设备的基本信息
config["测试设备地址"] = 967353
config["设备PWD000A"] = 15391
config["设备类型0001"] = "FF FF 17 00 04 00 01 00"
config["应用层通讯协议及版本0002"] = "EASTSOFT(v1.0)"
config["设备描述信息设备制造商0003"] = "ESDT-CTP4(v1.5)-20210223"
config["DKEY0005"] = "00000SH8"
config["SN0007"] = "31 71 30 10 20 11 92 31 01 00 00 34"
...
config["适配层版本号0606"] = "ESMD-AD6768(v1.1)-20180706"
config["网络层物料编码0609"] = "83676800202"
config["网络层版本号060A"] = "SSC1667-PLC(v5.0)-20180706"
# 定义被测设备上电后初始化时间
config["被测设备上电后初始化时间"] = 25
engine.config(config)

if __name__ == "__main__":
    import os

    # 设置测试文档的输出目录，默认输出到 test11_4寸智能终端 文件夹下
