...
# 配置测试报告基本信息
config = dict()
config["测试程序名称"] = r"3按键智能开关ESTK-03测试报告"
# 定义抄控器的基本信息
config["串口"] = "COM14"
config["波特率"] = "115200"     # 当前测试上位机，只支持9600bps和115200bps
config["校验位"] = 'None'
config["抄控器默认源地址"] = 128
config["panid"] = 1128  # 平板网关展架：14168；平板网关MAX：11176；三相智能网关展架：9113
# 定义测试设备的基本信息
config["测试设备地址"] = 341010
config["设备PWD000A"] = 17698
config["设备类型0001"] = "FF FF 02 00 33 01 03 00"
config["应用层通讯协议及版本0002"] = "EASTSOFT(v1.0)"
config["设备描述信息设备制造商0003"] = r"ESTK-03(v2.0)-20210518"
config["DKEY0005"] = "0000JKY6"
config["SN0007"] = "31 71 20 20 40 52 12 11 01 00 00 01"
...
config["应用程序上一版发布版本"] = r"ESTK-03-3S1A(v1.3)-20191205"  # 如果此处为空字符串时，表示不支持兼容性升级或手动测试。
