...
# 配置测试报告基本信息
config = dict()
config["测试程序名称"] = r"红外转发器ESCV-IRPL-TH-A测试"
# 定义抄控器的基本信息
config["串口"] = "COM24"
...
# 定义测试设备的基本信息
config["测试设备地址"] = 12338
config["设备PWD000A"] = 55875
config["设备类型0001"] = "FF FF 09 00 01 00 02 00"
config["应用层通讯协议及版本0002"] = "EASTSOFT(v1.0)"
config["设备描述信息设备制造商0003"] = "ESCV-IRPL-TH-A(v1.8)-20210120"
config["DKEY0005"] = "000013B0"
config["SN0007"] = "31 71 40 10 00 41 74 71 99 00 00 01"
