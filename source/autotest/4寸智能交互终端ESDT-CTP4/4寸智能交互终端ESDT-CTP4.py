...
# 配置测试报告基本信息
config = dict()
config["测试程序名称"] = r"ESDT-CTP4(v1.5)-20201207"
# 定义抄控器的基本信息
config["串口"] = "COM6"
config["波特率"] = "115200"
config["校验位"] = 'None'
...
# 定义测试设备的基本信息
config["测试设备地址"] = 178288
config["设备PWD000A"] = 6829
config["设备类型0001"] = "FF FF 17 00 04 00 01 00"
config["应用层通讯协议及版本0002"] = "EASTSOFT(v1.0)"
config["设备描述信息设备制造商0003"] = "ESDT-CTP4(v1.5)-20201207"
config["DKEY0005"] = "0000555W"
config["SN0007"] = "32 01 30 10 01 22 04 71 99 00 00 01"
