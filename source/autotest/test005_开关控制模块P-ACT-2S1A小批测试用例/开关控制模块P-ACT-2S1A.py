...
# 配置测试报告基本信息
config = dict()
config["测试程序名称"] = r"开关控制模块P-ACT-2S1A小批测试报告"
# 定义抄控器的基本信息
config["串口"] = "COM24"
...
# 定义测试设备的基本信息
config["测试设备地址"] = 635093
config["设备PWD000A"] = 52438
config["设备类型0001"] = "FF FF 13 00 00 00 02 00"
config["应用层通讯协议及版本0002"] = "EASTSOFT(v1.0)"
config["设备描述信息设备制造商0003"] = "ESACT-1A(v1.5)-20200805"
config["DKEY0005"] = "0000HFRN"
config["SN0007"] = "32 01 10 10 10 21 73 21 99 00 00 01"
