...
config["应用程序上一版发布版本"] = "P-TK-05-FC-IJ(v1.1)-20201102"  # 如果此处为空字符串时，表示不支持兼容性升级或手动测试。
config["应用程序同版本号测试版本"] = "P-TK-05-FC-IJ(v1.1)-20201102"
# 根据被测设备不同的载波版本，分别设置1663和1667参数
# config["载波适配层上一版本"] = "ESMD-AD63(v2.1)-20170210"
# config["载波网络层上一版本"] = "SSC1663-PLC(v1.0)-20170510"
config["载波适配层上一版本"] = "ESMD-AD6768(v1.2)-20200701"
config["载波网络层上一版本"] = "SSC1667-PLC(v5.0)-20190907"
