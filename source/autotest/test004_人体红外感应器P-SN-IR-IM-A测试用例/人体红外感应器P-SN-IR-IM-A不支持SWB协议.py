...
# 配置测试报告基本信息
config = dict()
config["测试程序名称"] = r"人体红外感应器P-SN-IR-IM-A测试报告"
# 定义抄控器的基本信息
config["串口"] = "COM24"
...
# 定义测试设备的基本信息
config["测试设备地址"] = 816168
config["设备PWD000A"] = 61169
config["设备类型0001"] = "FF FF 16 00 04 00 00 00"
config["应用层通讯协议及版本0002"] = "EASTSOFT(v1.0)"
config["设备描述信息设备制造商0003"] = "P-SN-IR-IM-A(v1.1)-20200727"
config["DKEY0005"] = "00002UWX"
config["SN0007"] = "31 72 10 10 01 31 92 61 01 00 00 18"
