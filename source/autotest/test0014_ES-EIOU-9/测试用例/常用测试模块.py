...
def choice_temp_test_type(type=None):
    ...
    if type == type_list[0]:
        ...
        engine.send_FE02_did('WRITE', 'IO配置D201', '01 20 02 20 03 20 04 20 05 20 06 20 07 20 08 20 09 20', cmd_outer='02')
        engine.expect_FE02_did('WRITE', 'IO配置D201', '01 20 02 20 03 20 04 20 05 20 06 20 07 20 08 20 09 20', cmd_outer='02')
    elif type == type_list[1]:
        engine.add_doc_info('配置为NTC10K-3950(0x21)输入模式')
        engine.send_FE02_did('WRITE', 'IO配置D201', '01 21 02 21 03 21 04 21 05 21 06 21 07 21 08 21 09 21', cmd_outer='02')
        engine.expect_FE02_did('WRITE', 'IO配置D201', '01 20 02 20 03 20 04 20 05 20 06 20 07 20 08 20 09 20', cmd_outer='02')
    elif type == type_list[2]:
        engine.add_doc_info('配置为PT1000(0x22)输入模式')
        engine.send_FE02_did('WRITE', 'IO配置D201', '01 22 02 22 03 22 04 22 05 22 06 22 07 22 08 22 09 22', cmd_outer='02')
        engine.expect_FE02_did('WRITE', 'IO配置D201', '01 22 02 22 03 22 04 22 05 22 06 22 07 22 08 22 09 22', cmd_outer='02')
    elif type == type_list[3]:
        engine.add_doc_info('配置为NI1000(0x23)输入模式')
        engine.send_FE02_did('WRITE', 'IO配置D201', '01 23 02 23 03 23 04 23 05 23 06 23 07 23 08 23 09 23', cmd_outer='02')
        engine.expect_FE02_did('WRITE', 'IO配置D201', '01 23 02 23 03 23 04 23 05 23 06 23 07 23 08 23 09 23', cmd_outer='02')
    elif type == type_list[4]:
        engine.add_doc_info('配置为NTC20K-3950(0x24)输入模式')
        engine.send_FE02_did('WRITE', 'IO配置D201', '01 24 02 24 03 24 04 24 05 24 06 24 07 24 08 24 09 24', cmd_outer='02')
        engine.expect_FE02_did('WRITE', 'IO配置D201', '01 24 02 24 03 24 04 24 05 24 06 24 07 24 08 24 09 24', cmd_outer='02')
    else:   # type == 25
        engine.add_doc_info('配置为NTC100K-3950(0x25)输入模式')
        engine.send_FE02_did('WRITE', 'IO配置D201', '01 25 02 25 03 25 04 25 05 25 06 25 07 25 08 25 09 25', cmd_outer='02')
        engine.expect_FE02_did('WRITE', 'IO配置D201', '01 25 02 25 03 25 04 25 05 25 06 25 07 25 08 25 09 25', cmd_outer='02')
