...
def report_gateway_expect(expect_value="00", wait_times=[15], ack=True, quit_net=False, wait_enable=False):
    """
    添加上报测试
    :param wait_enable:
    ...
    for i, wait_time in enumerate(wait_times):
        ...
        if config["被测设备类型"] == "开关":
            ...
            engine.add_doc_info('按键面板无入网状态上报，非执行器')
    if wait_enable:
