...
class ESMainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.medias_dict = media.Media.get_sub_class_instances()
        self.protocols_dict = protocol.Protocol.get_sub_class_instances()
        self.init_menu()
        layout = QHBoxLayout()
    ...
    def log_history_clicked(self, row, col):
        ...
        readable_text =  self.get_current_protocol().to_readable_str
